...
export const PLANTS = {
  peashooter: { name: '豌豆射手', emoji: '🌱', cost: 100, hp: 100, cooldown: 4,  desc: '穩定輸出', refund: 0.5 },
  sunflower:  { name: '向日葵',   emoji: '🌻', cost: 50,  hp: 80,  cooldown: 5,  desc: '生產陽光', refund: 0.5 },
  wallnut:    { name: '堅果牆',   emoji: '🥔', cost: 75,  hp: 360, cooldown: 10, desc: '厚血擋線', refund: 0.5 },
  repeater:   { name: '雙發射手', emoji: '🌿', cost: 175, hp: 100, cooldown: 7,  desc: '一次兩發', refund: 0.5 },
  icepea:     { name: '冰豆射手', emoji: '🧊', cost: 150, hp: 95,  cooldown: 7,  desc: '附帶緩速', refund: 0.5 },
  bomb:       { name: '櫻桃炸彈', emoji: '🍒', cost: 125, hp: 999, cooldown: 14, desc: '範圍爆炸', refund: 0 },
  prism:      { name: '稜鏡花',   emoji: '💠', cost: 160, hp: 90,  cooldown: 9,  desc: '會打兩排的折射花', refund: 0.5 },
  gambler:    { name: '賭徒花',   emoji: '🎲', cost: 140, hp: 85,  cooldown: 8,  desc: '傷害亂跳，偶爾暴擊', refund: 0.5 },
  chomper:    { name: '大嘴花',   emoji: '🪴', cost: 150, hp: 90,  cooldown: 12, desc: '秒殺一隻殭屍，嚼很久', refund: 0.5 },
  torchwood:  { name: '火炬樹',   emoji: '🔥', cost: 175, hp: 120, cooldown: 8,  desc: '豌豆經過變火球，2x傷害+濺射', refund: 0.5 },
};
